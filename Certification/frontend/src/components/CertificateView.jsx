    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          {/* Header */}
          <h2 className="text-2xl font-semibold text-gray-700 mb-2 tracking-wide">ReallyGreatAssociation</h2>
          ...
          <p className="text-gray-700 mb-8 text-base max-w-xl mx-auto">
            has successfully completed the online course program and is able to apply the knowledge acquired during training in practice.
          </p>

          {/* Details */}
          <div className="bg-gray-50 p-6 rounded-xl mb-8 shadow-inner">
            <p className="mb-4 text-gray-800"><span className="font-semibold">Course:</span> {certificate.courseName || "N/A"}</p>
            <p className="mb-4 text-gray-800"><span className="font-semibold">Grade:</span> {certificate.grade || "N/A"}</p>
          ...
          <div className="flex justify-between items-center mt-10 border-t border-gray-200 pt-6">
            <div className="text-left">
              ...
              <p className="text-gray-600 text-sm">Head of Trainee Management</p>
            </div>
